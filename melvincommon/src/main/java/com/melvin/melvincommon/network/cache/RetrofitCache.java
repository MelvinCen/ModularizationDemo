package com.melvin.melvincommon.network.cache;
...
public class RetrofitCache {
    ...
    public static <T> Observable<T> load(final String cacheKey,
        ...
        if (forceRefresh) {
            ...
            Logger.e("RetrofitCache -- load -- forceRefresh == false");
            Logger.e("RetrofitCache -- load -- forceRefresh == false -- fromCache = " + fromCache);
//            return fromNetWork;
