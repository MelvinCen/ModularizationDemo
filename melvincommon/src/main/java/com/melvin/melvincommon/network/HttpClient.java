package com.melvin.melvincommon.network;

import com.melvin.melvincommon.BuildConfig;
import com.melvin.melvincommon.network.interceptor.CalculatTimeInterceptor;
import com.melvin.melvincommon.network.interceptor.HttpLogger;
...
//        File cacheFile = FileUtils.getDiskCacheDir(BaseApplication.getInstance().getApplicationContext(), "cacheData");
        File cacheFile = new File(CommonRefUtils.getContext().getCacheDir(), "cache");
        Logger.e("cacheFile = " + cacheFile);
        ...
        if (BuildConfig.DEBUG) {
            ...
            builder.addNetworkInterceptor(new CalculatTimeInterceptor());
