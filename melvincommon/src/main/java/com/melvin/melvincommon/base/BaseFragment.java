...
import com.melvin.melvincommon.network.callback.BaseImpl;
...
public abstract class BaseFragment<P extends BasePresenter> extends Fragment implements BaseImpl {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Logger.e("isFirstVisible = " + isFirstVisible + " isFragmentVisible = " + isFragmentVisible + " rootView = " + rootView);
        ...
        if (isVisibleToUser && isFirstVisible) {
            Logger.e("setUserVisibleHint中去执行onFragmentFirstVisible");
        ...
        if (isVisibleToUser) {
            Logger.e("setUserVisibleHint中去执行onFragmentVisibleChange");
        ...
        if (rootView == null) {
            ...
            if (getUserVisibleHint()) {
                if (isFirstVisible) {
                    //可见并且是第一次可见的时候
                    isFirstVisible = false;
                    Logger.e("onViewCreated中去执行onFragmentFirstVisible");
                    onFragmentFirstVisible();
                }
                Logger.e("onViewCreated中去执行onFragmentVisibleChange");
                onFragmentVisibleChange(true);
                isFragmentVisible = true;
            }
        }
